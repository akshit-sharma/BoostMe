 ...
 */
public class SharedDummyContent {

    /**
     * An array of sample (dummy) items.
     */
    public static final List<SharedDummyItem> ITEMS = new ArrayList<SharedDummyItem>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static final Map<String, SharedDummyItem> ITEM_MAP = new HashMap<String, SharedDummyItem>();
